...
class JsonSpraySpec extends AnyFlatSpec with should.Matchers {
  ...
  val AddressJson =
    """{"city":"Los Angeles","country":"USA","house":"Unknown","postCode":"Unknown","region":"California","street":"Unknown"}"""

  val AddressObject: Address = Address(city = "Los Angeles",
                                       country = "USA",
                                       house = "Unknown",
                                       postCode = "Unknown",
                                       region = "California",
  ...
  val PersonObject: Person = Person(firstName = "Tyler",
                                    lastName = "Durden",
                                    age = 45,
